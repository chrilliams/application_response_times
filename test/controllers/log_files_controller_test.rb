...
class LogFilesControllerTest < ActionController::TestCase
  ...
  test "should create log_file" do
    assert_difference('LogFile.count') do
      post :create, log_file: { fields: @log_file.fields, file_name: @log_file.file_name, line_format: @log_file.line_format }
    end
  ...
  test "should update log_file" do
    patch :update, id: @log_file, log_file: { fields: @log_file.fields, file_name: @log_file.file_name, line_format: @log_file.line_format }
    assert_redirected_to log_file_path(assigns(:log_file))
  end
